  ...
  return (
    <aside className="flex flex-col overflow-y-auto shrink-0 w-[264px] h-screen bg-[#0B1E4B] text-white shadow-[2px_0_20px_rgba(11,30,75,0.30)]">
      ...
      <div className="p-4 border-t border-white/[0.07] mt-auto">
        <button
          className="w-full flex items-center cursor-pointer font-semibold gap-2 px-4 py-2.5 rounded-lg bg-white/[0.07] text-white/75 border border-white/10 text-[13px] transition-all hover:bg-[#E11D48] hover:border-[#E11D48] hover:text-white"
